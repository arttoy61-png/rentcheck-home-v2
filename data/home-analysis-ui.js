(()=>{
  ...
  if(!document.querySelector('link[data-public-housing-popup]')){
    ...
    popupStyle.href='/data/public-housing-popup.css?v=20260829-2';
  ...
  const mobile=Boolean(window.matchMedia&&window.matchMedia('(max-width: 768px)').matches);
  if(mobile){
    document.documentElement.classList.remove('rc-new-alert-open');
    document.body.classList.remove('notice-modal-open');
    document.querySelectorAll('#rcNewHousingAlert,.rc-new-alert').forEach(node=>node.remove());
  }else{
    if(!document.querySelector('link[data-new-housing-alert]')){
      ...
      alertStyle.href='/data/new-housing-alert.css?v=20260831-4';
    ...
    if(!document.querySelector('script[data-new-housing-alert]')){
      ...
      alertScript.src='/data/new-housing-alert.js?v=20260831-4';
