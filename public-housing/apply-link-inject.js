(()=>{
  ...
  function apply(){
    ...
    link.textContent=`${ag}에서 신청하기 →`;
    const note=document.createElement('small');note.className='housing-apply-note';note.textContent='공식 청약 시스템으로 이동합니다. 신청 전 공고명과 접수기간을 다시 확인하세요.';
